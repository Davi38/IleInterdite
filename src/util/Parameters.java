...
public class Parameters {
    ...
    public static final Boolean SIMPLIFIED = true ; // Processus simplifi̩ (pas d'interruption pendant les tours)
    
    // ====================================================================================
    // Param̬tres IHM
    public static final Boolean UNDECORATED = true ; // Indique si la barre de fen̻tre doit ̻tre affich̩e
    public static final Integer DECORATION_HEIGHT = 25 ; // Taille de la barre de fen̻tre
    public static final Boolean RESIZABLE = false ; // Indique si les fen̻tres peuvent ̻tre redimensionn̩es
    public static final Integer SWING_BORDERS_HEIGHT = 4 ; // Taille des bordures de c̫t̩ d'une fen̻tre
    public static final Integer TOP_VUE_AVENTURIER = UNDECORATED ? 30 : 0 ; // Position des fen̻tres aventuriers
    public static final Integer TOP_AUTRES_VUES = 265 - (UNDECORATED ? 0 : DECORATION_HEIGHT) ; // Position des fen̻tres Niveau, Plateau et Message en NoPic
    public static final Integer HAUTEUR_VUE_AVENTURIER = 200 ; // Hauteur des fen̻tres Aventurier
    public static final Integer HAUTEUR_AUTRES_VUES = 491 + (UNDECORATED ? 0 : DECORATION_HEIGHT) ; // Hauteur des fen̻tres Niveau, Plateau et Message

    // ====================================================================================
    // Jeu
    public static final Integer NB_INONDATIONS_INITIALES = (SIMPLIFIED ? 6 : 6) ; // Nombre de tuiles inond̩es au d̩marrage du jeu
    public static final Integer NB_MONTEES_DES_EAUX = (SIMPLIFIED ? 2 : 3) ; // Nombre de cartes Mont̩es des Eaux en jeu simplifi̩ ou non
    public static final Integer NB_HELICOPTERES = 3 ; // Nombre de cartes H̩licopt̬re
    ...
    public static Color TUILE_ASSECHEE_BG = Color.WHITE; // Couleur de fond d'une tuile ass̩ch̩e
    public static Color TUILE_INONDEE_BG = new Color(138, 169, 204); // Couleur de fond d'une tuile inond̩e
    public static Color COULEUR_TUILE_ASSECHEE_GRISEE = new Color(192, 192, 192); // Couleur de fond d'une tuile ass̩ch̩e non cliquable
    public static Color COULEUR_TUILE_INONDEE_GRISEE = new Color(175, 192, 192); // Couleur de fond d'une tuile ass̩ch̩e non cliquable
